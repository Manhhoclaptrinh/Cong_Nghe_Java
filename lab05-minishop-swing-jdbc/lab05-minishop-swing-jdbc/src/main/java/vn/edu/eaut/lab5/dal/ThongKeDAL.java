...
public class ThongKeDAL {
    ...
    public String hoaDonCaoNhat() throws SQLException {
        ...
        try (Connection conn = DBHelper.getConnection();
            ...
            return String.format("Ma HD: %d | Ngay: %s | Ma KH: %d | Tong: %s VND",
                    rs.getInt("ma_hd"), rs.getDate("ngay_lap"),
                    rs.getInt("ma_kh"), rs.getBigDecimal("tong_tien"));
        }
    }
    ...
    public String sanPhamBanChay() throws SQLException {
        ...
        try (Connection conn = DBHelper.getConnection();
            ...
            return String.format("Ma SP: %d | %s | Da ban: %d",
                    rs.getInt("ma_sp"), rs.getString("ten_sp"), rs.getInt("tong_so_luong"));
        }
    }
}
